...
icon:check[] Migration: A bug was fixed which prevented the field rename changes to be executed correctly.

[[v0.40.3]]
== 0.40.3 (TBD)

icon:check[] Migration: It is now possible to apply schema / microschema changes that include the `name` property. Previously the name property was not utilized.
